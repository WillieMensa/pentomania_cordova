/*	=============================================================================
	Pentomino Puzzle
	archivo: pentomino-puzzle-12.js
	6/7/2019
...
//-------------------------------------
var BACKGROUND_COLOR = '#ddff99';	// "#446622";	//	"#ddff99";
...
function init()
{
	...
	//	if (DEBUG) { console.log('gPolyGroup: ' + gPolyGroup + '\nconsole.trace()' + console.trace() )	};
...
function MenuInicial() {
	...
	document.getElementById('helpBtn').style.cssText = "top:" + (100) + "px; left:" + (50) + "px; position: absolute;";
	document.getElementById('aboutBtn').style.cssText = "top:" + (150) + "px; left:" + (50) + "px; position: absolute;";
	...
	visibleMnuButton()	// visible all buttons in main menu
...
//--------------------------
function enableMnuButton()		// enable buttons in main menu
{
...
//--------------------
// visible all buttons in main menu
function visibleMnuButton()
{
	//	document.getElementById('helpBtn').style.visibility='visible';
	//	document.getElementById('aboutBtn').style.visibility='visible';
...
function HaceInitLayer()  {	//	pantalla de inicio
	...
	if (DEBUG)	{	console.log(' en HaceInitLayer() - revisar esta funcion');	}
...
statusBtn.style.cssText = "top:" + (350) + "px; left:" + (050) + "px; position: absolute;";	// 4. Position in screen
	...
	//	gInitLayer.add(rect);	
	//	console.log('rect, agregado');
	
	//	Lo que sigue da error
	//	gInitLayer.add(btn);	
	//	console.log('btn, agregado');
...
function	HaceStatusLayer()	{
	...
	//	boton volver in javascript code
	menuBtn = document.createElement("button");
	menuBtn.innerHTML = "Inicio";
	document.body.appendChild(menuBtn);
	menuBtn.addEventListener ("click", function() {  MenuInicial() } );// 3. Add event handler
	menuBtn.style.cssText = "top:" + (350) + "px; left:" + (050) + "px; position: absolute;";	// 4. Position in screen
...
function initBoardState(boardX, boardY, numOfFixedBlocks, newPuzzle)
{
	...
	console.log( 'BLOCK_CELL_SIZE = BOARD_WIDTH / SCREEN_BOARD_X: ' +
		BLOCK_CELL_SIZE +', '+ BOARD_WIDTH +', '+ SCREEN_BOARD_X );
