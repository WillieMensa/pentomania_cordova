/*	=============================================================================
	Pentomino Puzzle
	archivo: pentomino-puzzle-07.js
		derivado directamente de pentomino-puzzle-05.js

	1/ Reemplazo del container por el canvas
	
	Se intentan las siguientes correcciones:
...
function init()
{
	...
	xCanvas.height=STAGE_Y - 50 ;
	xCanvas.style="border:05px solid #000000";
	document.body.appendChild(xCanvas);


	
	if (DEBUG) { 
		alert('ya pasamos el createStageLayer');
	...
	if (DEBUG)
	{
		writeMessage("Cell " +BLOCK_CELL_SIZE + " STAGE_X: " + STAGE_X + " STAGE_Y: " + STAGE_Y + "offX:" + STAGE_OFFSET_X + "offY:" + STAGE_OFFSET_Y);
	}
...
function playPuzzle()
{
	...
	if (DEBUG) { 
		console.log('linea 285, playPuzzle, gPolyGroup: ' + gPolyGroup);		
	};
