...
// define
//=========
const versionString="0.8.3"			//	lleva el numero de version actual
...
var dist_X = Math.floor(STAGE_X / 5 )
	...
	volteaPieza.style.left	=	STAGE_OFFSET_X + 1.2 * dist_X - BLOCK_CELL_SIZE;	//	STAGE_OFFSET_X + 4.0 * BLOCK_CELL_SIZE;
	...
	hintBtn.style.left			=	STAGE_OFFSET_X + 2.0 * dist_X - BLOCK_CELL_SIZE;	//	STAGE_OFFSET_X + 7.0 * BLOCK_CELL_SIZE;
  ...
  checkBtn.setAttribute("type", "checkbox");
	...
	checkBtn.style.left = STAGE_OFFSET_X + 3.0 * dist_X - BLOCK_CELL_SIZE;	//	10 * BLOCK_CELL_SIZE;
