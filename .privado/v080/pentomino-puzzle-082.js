...
// define
//=========
const versionString="0.8.21"			//	lleva el numero de version actual
...
var dist_X = Math.floor(STAGE_X / 5 )
	...
	menuBtn.style.left	=	STAGE_OFFSET_X + 3.5 * dist_X - BLOCK_CELL_SIZE;
...
function MenuInicial() {
	...
	//	if (DEBUG){	console.log("document.getElementById('mySelect'): " + document.getElementById('mySelect')) }
...
if (DEBUG){
	...
	//	---------------------------------
	//	solo para depurar
	function mostrarContenidoObjeto(event)
	{
			var resultado=recorrerObjeto(event);
			return resultado;
	}
